...
\begin{itemize}
  ...
  \item Uso de Capuchino: 48\% solo en inscripción, 44\% varias veces por semestre.
...
\begin{table}[H]
  \centering
  \caption{Trazabilidad de hallazgos a requerimientos del área. Fuente: Elaboración propia (encuesta n=126).}
