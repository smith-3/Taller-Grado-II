...
\begin{table}[H]
  ...
  \label{PLACEHOLDER}
  \small{Fuente: Elaboración propia.}\label{tab:f6_resumen_ux}
\end{table}
...
\begin{table}[H]
  ...
  \label{PLACEHOLDER}
  \small{Fuente: Elaboración propia.}\label{tab:f6_entry_exit}
\end{table}
...
\begin{table}[H]
  ...
  \label{PLACEHOLDER}
  \small{Fuente: Elaboración propia.}\label{tab:f7_notif_ai}
\end{table}
...
\begin{table}[H]
  ...
  \label{PLACEHOLDER}
  \small{Fuente: Elaboración propia.}\label{tab:f7_entry_exit}
\end{table}
...
\begin{table}[H]
  ...
  \label{PLACEHOLDER}
  \small{Fuente: Elaboración propia.}\label{tab:f8_export}
\end{table}
...
\begin{table}[H]
  ...
  \label{PLACEHOLDER}
  \small{Fuente: Elaboración propia.}\label{tab:f8_tecnico}
\end{table}
...
\begin{table}[H]
  ...
  \label{PLACEHOLDER}
  \small{Fuente: Elaboración propia.}\label{tab:f8_entry_exit}
\end{table}
