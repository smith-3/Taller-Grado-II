...
Para evaluar el desempeño y la aceptación del sistema, se han definido indicadores clave de rendimiento (KPIs). Estos métricas permiten cuantificar la eficiencia de los algoritmos de generación, la calidad de los horarios resultantes y la fiabilidad de las funciones auxiliares, estableciendo metas cuantitativas en las siguientes dimensiones:
