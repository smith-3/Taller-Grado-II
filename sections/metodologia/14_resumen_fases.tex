...
Los aspectos operativos de esta fase se resumen a continuación:
\begin{itemize}
...
El diseño de UX se valida mediante pruebas con usuarios piloto que identifican puntos de fricción y oportunidades de mejora. Los aspectos principales son:
...
\begin{itemize}
  ...
  \item Actividades desarrolladas: Canales separados (clases/mensajes), WorkManager, plantillas; gestión del modelo IA (descarga/borrado; Wi-Fi/datos; sin telemetría).
